...
import { IonSearchbar, LoadingController, Platform, ActionSheetController, ToastController, AlertController } from '@ionic/angular';
...
export class AddPostPage implements OnInit {
  ...
  async addPost() {
    ...
    this.postService.addPost(this.postForm.value,this.poster).then(async res => {
      loading.dismiss();

...
import { MenuController, ModalController, IonContent, Platform, NavController } from '@ionic/angular';
...
export class HomePage implements OnInit {
  ...
  @ViewChild('triggerElement' , {read: ElementRef, static: true }) triggerdElement: ElementRef;
...
this.observer.observe(this.triggerdElement.nativeElement);
